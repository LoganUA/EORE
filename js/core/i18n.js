...
const STRINGS = {
  uk:{
    ...
    dfRosterBtn:"Сапери",
    deminerRosterHeader:"Сапери",
    dfDeminerName:(n)=>`Сапер ${n}`,
    dfStateIdle:"Готовий",
    dfStateWorking:"Працює",
    dfStateResting:"Відпочиває",
    dfStat_stamina:"Витривалість",
    dfStat_equipment:"Спорядження",
    dfStat_speed:"Швидкість",
    dfUpgradeBtn:(cost)=>`Прокачати · 🪙${cost}`,
    dfStatMaxed:"Максимум",
    dfHireBtn:(cost)=>`Найняти сапера · 🪙${cost}`,
    dfMaxDeminersReached:"Досягнуто ліміту саперів",
    dfAllBusyTitle:"Усі сапери зайняті",
    dfAllBusyText:"Почекай, поки хтось із саперів звільниться або відпочине, або найми ще одного у розділі «Сапери».",
    dfCommunityBtn:(cost)=>`Домовитись з громадою · 🪙${cost}`,
    trueLabel:"Правда",
    falseLabel:"Неправда",
    stampTrue:"ПРАВДА",
    stampFalse:"НЕПРАВДА",
  ...
  en:{
    ...
    dfRosterBtn:"Deminers",
    deminerRosterHeader:"Deminers",
    dfDeminerName:(n)=>`Deminer ${n}`,
    dfStateIdle:"Ready",
    dfStateWorking:"Working",
    dfStateResting:"Resting",
    dfStat_stamina:"Stamina",
    dfStat_equipment:"Equipment",
    dfStat_speed:"Speed",
    dfUpgradeBtn:(cost)=>`Upgrade \u00b7 \ud83e\ude99${cost}`,
    dfStatMaxed:"Maxed out",
    dfHireBtn:(cost)=>`Hire a deminer \u00b7 \ud83e\ude99${cost}`,
    dfMaxDeminersReached:"Deminer roster is full",
    dfAllBusyTitle:"All deminers are busy",
    dfAllBusyText:"Wait for a deminer to free up or finish resting, or hire another one from the Deminers screen.",
    dfCommunityBtn:(cost)=>`Negotiate with the community \u00b7 \ud83e\ude99${cost}`,
    trueLabel:"True",
    falseLabel:"False",
    stampTrue:"TRUE",
    stampFalse:"FALSE",
